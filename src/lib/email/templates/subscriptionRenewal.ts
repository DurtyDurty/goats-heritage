        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding:0 0 32px;">
              <h2 style="margin:0 0 16px;font-family:Arial,sans-serif;font-size:22px;color:#333;">Your Heritage Box is Coming</h2>
              ...
              <p style="margin:0 0 24px;font-family:Arial,sans-serif;font-size:14px;line-height:1.7;color:#333;">
                Your <strong>${tier}</strong> subscription has been renewed successfully. Another Heritage Box is on its way soon.
              </p>

              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;border:1px solid #e5e5e5;border-radius:6px;">
                <tr>
                  <td style="padding:20px;">
                    <p style="margin:0 0 4px;font-family:Arial,sans-serif;font-size:13px;color:#666;font-weight:600;">Next Billing Date</p>
                    <p style="margin:0;font-family:Arial,sans-serif;font-size:18px;color:#333;font-weight:600;">${formattedDate}</p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                <tr>
                  <td>
                    <a href="${siteUrl}/account/subscription" target="_blank" style="display:inline-block;padding:12px 24px;background:#C8A84E;color:#000;font-family:Arial,sans-serif;font-weight:bold;text-decoration:none;border-radius:6px;font-size:14px;">Manage Subscription</a>
                  </td>
                </tr>
              </table>
            </td>
